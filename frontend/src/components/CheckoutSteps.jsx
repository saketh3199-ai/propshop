...
const CheckoutSteps = ({step1,step2,step3,step4}) => 
{
    ...
    <Nav className='justify-content-center mb-4'>
        ...
        <Nav.Item>
                {step4?(<LinkContainer to='/placeorder'><Nav.Link>placeorder</Nav.Link></LinkContainer>):(<Nav.Link disabled>placeorder</Nav.Link>)}
        </Nav.Item>
    </Nav>
  
    return CheckoutStepsJsx
